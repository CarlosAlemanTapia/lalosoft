                                        ...
                                        <div class="card-header"><strong>Ingresa bien</strong><small> lo siguiente</small></div>
                                            <div class="card-body card-block">
                                                <form>
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <label for="company" class=" form-control-label">Nombre Cliente</label><input type="text" id="company" placeholder="Nombre Del Cliente" class="form-control" required="Ingresa este campo">
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <label for="vat" class=" form-control-label">Fecha De Prestamo</label><input type="text" id="vat" placeholder="<?php echo $ahora ?>" class="form-control" required="Ingresa este campo" value="<?php echo $ahora ?>" disabled="">
                                                        </div>
                                                    </div>
                                                    <br>
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <label for="company" class=" form-control-label">Monto</label><input type="number" id="company" placeholder="Ingresa el monto" class="form-control" required="Ingresa este campo">
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <label for="vat" class=" form-control-label">Interes</label><input type="text" id="vat" placeholder="5" value="5" class="form-control" disabled="" required="Ingresa este campo">
                                                        </div>
                                                    </div>
                                                     <br>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <label for="vat" class=" form-control-label">Responable</label><input type="text" id="vat" placeholder="<?= $user['nombre_us']; ?>" class="form-control" disabled="" value="<?= $user['nombre_us']; ?>">
                                                        </div>
                                                    </div>
                                                    <br>
