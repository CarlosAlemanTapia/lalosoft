                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">HISTORIAL DE PAGOS</strong>
                            </div>
                            <?php
								include_once "../base_de_datos.php";
								$sentencia = $base_de_datos->query("select pre.cliente_nombre, p.cobrador, p.fecha_pago, p.pago from pagos p inner join prestamos pre on p.id_prestamo = pre.id_prestamos order by id_pago desc ;");
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $producto->cobrador ?></td>
                                            <td><?php echo $producto->fecha_pago ?></td>
                                            <td><?php echo $producto->pago ?></td>
