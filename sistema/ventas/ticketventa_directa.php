...
<body onload="imprimir()">
    ...
    <div style="width: 150px; height: 50px; margin-left: 400px; margin-top: -350px;">
        ...
        <br>
        <br>
        <a class="btn btn-danger" href="vistaventasbodega.php">Regresar  <i class="fa fa-chevron-left"></i></a>
    </div>
