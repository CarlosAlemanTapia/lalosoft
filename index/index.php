...
<div class="w3-content" style="max-width:1600px">
  ...
  <header class="w3-display-container w3-wide" id="home">
    <img class="w3-image" src="img/fondo.jpg" alt="Fashion Blog" width="1600" height="1060">
    <div class="w3-display-left w3-padding-large">
      <h1 class="w3-text-white" style="color: black;">BAZAR</h1>
      <h1 class="w3-jumbo w3-text-white w3-hide-small"><b>GEMANA</b></h1>
  ...
  <div class="w3-row w3-padding w3-border">
    ...
    <div class="w3-col l8 s12">
      ...
      <div class="w3-container w3-white w3-margin w3-padding-large">
        <div class="w3-center">
          <h3>Lavadora</h3>
          <h5>Exelente lavadora, <span class="w3-opacity">May 2, 2016</span></h5>
        </div>

        <div class="w3-justify">
          <img src="img/lavadora.jpg" alt="Girl Hat" style="width:100%" class="w3-padding-16">
          ...
          <p class="w3-right"><button class="w3-button w3-black"><b>Precio $  </b> <span class="w3-tag w3-white">2,500</span></button></p>
          <p class="w3-clear"></p>
      ...
      <div class="w3-container w3-white w3-margin w3-padding-large">
        ...
        <div class="w3-justify">
          <img src="img/ref.jpg" alt="Girl Hat" style="width:100%" class="w3-padding-16">
          <p><strong>More Hats!</strong> I am crazy about hats these days. Some text about this blog entry. Fashion fashion and mauris neque quam, fermentum ut nisl vitae, convallis maximus nisl. Sed mattis nunc id lorem euismod placerat. Vivamus porttitor
            magna enim, ac accumsan tortor cursus at. Phasellus sed ultricies mi non congue ullam corper. Praesent tincidunt sedtellus ut rutrum. Sed vitae justo condimentum, porta lectus vitae, ultricies congue gravida diam non fringilla.</p>
          <p>Sunt in culpa qui officia deserunt mollit anim id est laborum consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco.</p>
    ...
    <div class="w3-col l4">
      ...
      <div class="w3-white w3-margin">
        ...
        <div class="w3-container w3-black">
          <h4>Bazar Gemana</h4>
          <p>gkjjkbkjbkjhbhjkbhjkbjhbjh</p>
        </div>
      </div>
      <hr>
      <hr>
